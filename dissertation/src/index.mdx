...
export default class extends React.Component {
  constructor(props) {
    super(props);
    const global = this;
    this.state = { crossReferences: {}, tableOfContents: [] };
    ...
    this.components = {
            ...
            class extends React.Component {
              ...
              componentDidMount() {
                ...
                global.setState((state) => ({
                  crossReferences: { ...state.crossReferences, [id]: number },
      ...
      a: ({ href, children }) =>
        React.createElement(
          ...
          { href },
          href.startsWith("#")
            ? `§ ${global.state.crossReferences[href.slice(1)] ?? "??"}`
            : children
        ),
      TableOfContents: () => (
        <ul className="table-of-contents">
          {global.state.tableOfContents.map(({ id, heading }) => (
            <li key={id}>
              {React.createElement("a", { href: `#${id}` }, heading)}
            </li>
          ))}
        </ul>
      ),
