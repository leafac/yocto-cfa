...
export default class extends React.Component {
    ...
    this.components = {
        ...
        [1, 2, 3, 4, 5, 6].map((level) => {
          ...
          return [
            ...
            class extends React.Component {
              ...
              componentDidMount() {
                this.setState({
                  id: global.addHeading(level, this.props.children),
                });
              }
              render() {
                return React.createElement(
                  ...
                  <span class="heading-number">
                    {global.state.crossReferences[this.state.id]}{" "}
                  </span>,
                  this.props.children,
                  <code className="draft"> (#{this.state.id})</code>
                );
              }
            },
          ];
      ...
      TableOfContents: () => (
        <ul className="table-of-contents">
          {global.state.tableOfContents.map(({ id, number, heading }) => (
            <li key={id}>
              <a href={`#${id}`}>
  ...
  addHeading(level, children) {
    const id = this.slugger.slug(children);
    const number = this.numberer.number(level);
    this.setState((state) => ({
      crossReferences: {
