        ...
        [1, 2, 3, 4, 5, 6].map((level) => {
          ...
          return [
            ...
            class extends React.Component {
              constructor(props) {
                super(props);
                this.state = { id: null, number: null };
              }
              componentDidMount() {
                if (this.state.id === null) {
                  this.setState({
                    id: slugger.slug(this.props.children),
                    number: numberer.number(level),
                  });
                }
              }
              render() {
                return React.createElement(
                  type,
                  { id: this.state.id },
                  <span class="heading-number">{this.state.number}</span>,
                  this.props.children,
