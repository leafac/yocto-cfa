...
exports.createPages = async ({ graphql }) => {
  ...
  for (const processor of processors) processor(dom.window.document);
  fs.writeFileSync(
...
const processors = [
  function addHeadingsCounter(document) {
  ...
  function addSectionInformationOnTableOfContentsEntries(document) {
