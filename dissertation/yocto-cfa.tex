...
And the following is a trace of the recursive call to \mintinline{ts}{step()} in which that closure is used:

\begin{center}
\begin{tabular}{rrcl}
\multicolumn{4}{c}{\textbf{Trace 2: Recursive Call to \mintinline{ts}{step()} · Closure Use}} \\
\textbf{Line} & (see §~\ref{A Function Call}) & & \\
...
% TODO: Figure of arrows pointing at the bindings for the two different ‘x’s.
