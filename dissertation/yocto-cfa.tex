...
The source code for this dissertation and all accompanying programs is available at \url{https://github.com/leafac/yocto-cfa}.
...
TODO: Clarify that we aren’t talking about the kind of program analysis that ESLint does, for example. Or are we??

TODO: Some analysis require user input (like type annotations or eslint comments), but ours doesn’t

TODO: An example of why CFA is important: last paragraph in https://www.typescriptlang.org/docs/handbook/advanced-types.html\#type-guards-and-type-assertions

TODO: If context is “where have I been?” then call–return alignment is “where should I go?”
...
TODO: Have a version with operational semantics rules
...
% TODO: Don’t thread the store, but merge the stores?
% TODO: Another reason to introduce a store (besides removing the recursion in the closure data structure): allowing for mutable state (though we probably won’t implement it) (the environment still points to an address, but we update the address when the variable is mutated)
...
\begin{itemize}
  \item The three ingredients for m-CFA (to really be polynomial): Store Widening, Top-Frames, and environment flattening
\end{itemize}
