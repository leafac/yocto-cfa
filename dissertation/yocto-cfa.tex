...
\setmonofont{Courier}
% TODO: unicode-math \setmathfont{texgyrepagella-math.otf}
...
\begin{center}
\includegraphics[page = 2]{images-pdfa.pdf}
\end{center}
...
> parse("x => x")
\end{minted}
\includegraphics[page = 3]{images-pdfa.pdf}
\begin{minted}{ts}
{
...
> parse("(x => x)(y => y)")
\end{minted}
\includegraphics[page = 4]{images-pdfa.pdf}
\begin{minted}{ts}
{
  "type": "CallExpression",
  "callee": {
...
\begin{center}
\includegraphics[page = 5]{images-pdfa.pdf}
\end{center}
...
\begin{center}
\includegraphics[page = 6]{images-pdfa.pdf}
\end{center}
...
\begin{center}
\includegraphics[page = 7]{images-pdfa.pdf}
\end{center}
...
\begin{center}
\includegraphics[page = 8]{images-pdfa.pdf}
\end{center}
