...
\noindent This is similar to §~\ref{An Argument That Is Not Immediate} and §~\ref{A Function That Is Not Immediate}: the result of substitution may be not an immediate function but another call, and more work may be necessary to interpret it. We solve this with yet another recursive call to \mintinline{ts}{evaluate()} (note the removal of yet another check, making the \mintinline{ts}{substitutedBody} variable unnecessary and allowing us to inline it):
