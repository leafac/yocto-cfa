...
\textbf{Example Program:} & \mintinline{js}{(x => z => x)(y => y)} \\
\textbf{Current Output:} & — \\
\textbf{Expected Output:} & $\langle \mintinline{js}{(z => x)}, [\mintinline{js}{x} \mapsto \mintinline{js}{(y => y)}] \rangle$ \\
\end{tabular}
\end{center}
...
\textbf{Current Output:} & $\langle \mintinline{js}{(z => x)}, [\mintinline{js}{x} \mapsto \mintinline{js}{(y => y)}] \rangle$ \\
\textbf{Expected Output:} & $\langle \mintinline{js}{(z => x)}, [\mintinline{js}{x} \mapsto \mintinline{js}{(y => y)}] \rangle$ \\
\end{tabular}
\end{center}
