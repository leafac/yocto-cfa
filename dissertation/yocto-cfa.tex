...
These definitions are written as TypeScript types. They correspond to the elements in the Yocto-JavaScript grammar (see §~\ref{a-formal-grammar-for-yocto-javascript}). They are adapted from the ESTree specification to include only the features supported by Yocto-JavaScript.
