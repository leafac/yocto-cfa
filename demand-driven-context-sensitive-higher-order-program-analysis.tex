...
The Surface Language is the language in which we write our examples and tests. Before our analyzer can analyze a program in the Surface Language, it must be compiled~(§~\ref{section:compiling-the-surface-language-into-the-core-language}) into the Core Language~(§~\ref{section:surface-language}).
